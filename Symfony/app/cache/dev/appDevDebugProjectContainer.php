...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ParadigmBundle', ($this->targetDirs[2].'/Resources/ParadigmBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ParadigmBundle', ($this->targetDirs[3].'\\src\\Acme\\ParadigmBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('default' => 'doctrine.dbal.default_connection', 'customer' => 'doctrine.dbal.customer_connection'), array('default' => 'doctrine.orm.default_entity_manager'), 'default', 'default');
    }
    ...
    /**
     * Gets the 'doctrine.dbal.customer_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getDoctrine_Dbal_CustomerConnectionService()
    {
        ...
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.customer'));
        ...
        return $this->services['doctrine.dbal.customer_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'portfolio', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Acme\\ParadigmBundle\\Resources\\config\\doctrine') => 'Acme\\ParadigmBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Acme\\ParadigmBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Acme\\ShopBundle\\Entity'))), 'Acme\\ShopBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ParadigmBundle' => 'Acme\\ParadigmBundle\\Entity', 'ShopBundle' => 'Acme\\ShopBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_32112c19c5e8b4ce2122a8e0e2fcb4d973dcd2d93b8e8e4aba02df77561fbc5e');
    ...
    {
        return $this->services['genemu.form.core.type.tinymce'] = new \Genemu\Bundle\FormBundle\Form\Core\Type\TinymceType(array());
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('customer', $this->get('doctrine.dbal.logger.profiling.customer'));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'ParadigmBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Tuto\\BlogBundle/Resources/views'), 'TutoBlog');
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\ParadigmBundle/Resources/views'), 'Paradigm');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\genemu\\form-bundle\\Genemu\\Bundle\\FormBundle/Resources/views'), 'GenemuForm');
        $instance->addPath(($this->targetDirs[3].'\\src\\Acme\\ShopBundle/Resources/views'), 'Shop');
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.customer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TutoBlogBundle' => 'Tuto\\BlogBundle\\TutoBlogBundle',
                'ParadigmBundle' => 'Acme\\ParadigmBundle\\ParadigmBundle',
                'GenemuFormBundle' => 'Genemu\\Bundle\\FormBundle\\GenemuFormBundle',
                'ShopBundle' => 'Acme\\ShopBundle\\ShopBundle',

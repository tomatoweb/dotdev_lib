...
class WorksController extends Controller {
    ...
    public function worksAction(Request $request){
        ...
        $request->getSession()->set('auth', $user);// $this->get('session') OR $request->getSession()
    ...
    public function editAction(Request $request){        
        ...
        if ($request->getMethod() == 'POST'){ 
            ...
            //INSERT NEW
                ...
                //last insert Id
                //$work = $em->getRepository('ParadigmBundle:works')->findOneBy(array('id' => $work->getId())); 
            } 
            ...
            foreach ($_FILES['images']['name'] as $k => $v){ 
                ...
                if (in_array($image_ext, array('jpeg', 'jpg', 'png'))){                    
                    ...
                    */
                    ...
                    // run that command as admin to synchronise Bundle/Resources/public and web/bundles
                    ...
                    // Make a minified copy (270x180) of the image in public folder (\Symfony\src\Acme\ParadigmBundle\Resources\public\img\works)
        ...
        if($request->query->get('id')) {            
            ...
            if(!$work){
                $this->get('session')->getFlashBag()->set('flash', array('type'=>'danger','message'=>'Work not found for this Id'));
                return $this->forward('ParadigmBundle:Works:works');
            }            
        }
